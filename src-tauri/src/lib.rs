...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            capture::get_aux_scripts,
            capture::start_tcpdump_capture,
            capture::stop_tcpdump_capture,
            capture::open_capture_folder,
            capture::select_script_file,
            capture::save_aux_script,
            // 代理抓包
            capture::get_local_ip,
            capture::start_proxy_capture,
            capture::stop_proxy_capture,
            capture::export_proxy_cert,
            capture::install_proxy_cert,
            capture::check_mitmproxy_env,
            capture::install_mitmproxy,
            capture::get_mitmproxy_install_status,
            // 全流量实时抓包
            capture::start_realtime_capture,
            capture::get_realtime_packets,
            capture::stop_realtime_capture,
            capture::get_realtime_sessions,
            capture::get_realtime_session_packets,
            capture::delete_realtime_session,
            // AI 分析
            ai::get_ai_config,
            ai::save_ai_config,
